...
from tracker.my_bot_sort import BoTSORT
...
if __name__ == '__main__':
    ...
    # LSTM (no use)
    parser.add_argument('--LSTM_predict_thresh', type=float, default=0.5,
                        help='threshold for rejecting low IOU that LSTM matches to detections')
