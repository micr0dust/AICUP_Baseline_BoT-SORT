...
def exist_predict(inputs):
    ...
    # Apply sigmoid to the output and round to get binary prediction
    pred = torch.round(torch.sigmoid(output))

    # Convert the prediction to boolean and return
    return pred.item() > 0.5

if __name__ == "__main__":
    inputs = [[0, 0, 0, 0, 0],
          [0, 0.40684821605682375, 0.17069200636848572, 0.06779799461364741, 0.09316972702268564]]
    print("只靠上一個軌跡預測",exist_predict(inputs))
    ...
    print("靠兩個軌跡預測",exist_predict(inputs))